...
|----------|---------------------------------------|-----------------------------------------------------------------------------------|------------|
| `arr`    | npt.ArrayLike                         | A numpy ndarry, with initial shape $(n \times d)$                                 | _required_ |
...
| Type          | Description                                                                                                     |
|---------------|-----------------------------------------------------------------------------------------------------------------|
| npt.ArrayLike | npt.ArrayLike: After removing the last constant row of initial LHD, an $(n-1) \times d$ maximin LHD is returned |
